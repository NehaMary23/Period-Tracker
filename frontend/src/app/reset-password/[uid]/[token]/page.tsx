    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-100 to-rose-300">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-10 flex flex-col items-center">
        <div className="mb-6 flex flex-col items-center">
          ...
          <h2 className="text-3xl font-extrabold text-rose-600 mb-1">Reset Password</h2>
          <p className="text-gray-500 text-center text-sm">Enter your new password below. Make sure it's strong and secure.</p>
        </div>
        <form onSubmit={handleSubmit} className="w-full flex flex-col gap-4" aria-label="Reset Password Form">
          <div className="relative">
            <input
              type={showPassword ? "text" : "password"}
              className="w-full border border-rose-200 px-4 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-rose-400 transition"
          ...
          <button
            type="submit"
            className="w-full bg-rose-600 hover:bg-rose-700 text-white py-3 rounded-lg font-semibold transition disabled:opacity-60"
